...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    def nativeEvent(self, eventType: typing.Union[QtCore.QByteArray, bytes, bytearray], message: PyQt5.sip.voidptr) -> typing.Tuple[bool, int]: ...
    ...
    @staticmethod
    def find(a0: PyQt5.sip.voidptr) -> 'QWidget': ...
