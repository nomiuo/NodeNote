...
class QAbstractEventDispatcher(QObject):
    ...
    def filterNativeEvent(self, eventType: typing.Union['QByteArray', bytes, bytearray], message: PyQt5.sip.voidptr) -> typing.Tuple[bool, int]: ...
...
class QAbstractNativeEventFilter(sip.simplewrapper):
    ...
    def nativeEventFilter(self, eventType: typing.Union['QByteArray', bytes, bytearray], message: PyQt5.sip.voidptr) -> typing.Tuple[bool, int]: ...
...
class QFileDevice(QIODevice):
    ...
    def map(self, offset: int, size: int, flags: 'QFileDevice.MemoryMapFlags' = ...) -> PyQt5.sip.voidptr: ...
...
class QThread(QObject):
    ...
    @staticmethod
    def currentThreadId() -> PyQt5.sip.voidptr: ...
    @staticmethod
