...
class QColorConstants(sip.simplewrapper):

    class Svg(sip.simplewrapper):
...
class QOpenGLTexture(sip.simplewrapper):
    ...
    @typing.overload
    def setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, sourceFormat: 'QOpenGLTexture.PixelFormat', sourceType: 'QOpenGLTexture.PixelType', data: sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = ...) -> None: ...
    @typing.overload
    def setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, mipLevel: int, sourceFormat: 'QOpenGLTexture.PixelFormat', sourceType: 'QOpenGLTexture.PixelType', data: sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = ...) -> None: ...
    @typing.overload
    def setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, mipLevel: int, layer: int, sourceFormat: 'QOpenGLTexture.PixelFormat', sourceType: 'QOpenGLTexture.PixelType', data: sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = ...) -> None: ...
    @typing.overload
    def setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, mipLevel: int, layer: int, cubeFace: 'QOpenGLTexture.CubeMapFace', sourceFormat: 'QOpenGLTexture.PixelFormat', sourceType: 'QOpenGLTexture.PixelType', data: sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = ...) -> None: ...
    @typing.overload
    def setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, mipLevel: int, layer: int, cubeFace: 'QOpenGLTexture.CubeMapFace', layerCount: int, sourceFormat: 'QOpenGLTexture.PixelFormat', sourceType: 'QOpenGLTexture.PixelType', data: sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = ...) -> None: ...
...
class QPainter(sip.simplewrapper):
    ...
    @typing.overload
    def drawConvexPolygon(self, point: typing.Union[QtCore.QPointF, QtCore.QPoint], *a1: typing.Any) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawPolygon(self, point: typing.Union[QtCore.QPointF, QtCore.QPoint], *a1: typing.Any) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawPolyline(self, point: typing.Union[QtCore.QPointF, QtCore.QPoint], *a1: typing.Any) -> None: ...
    @typing.overload
    def drawPolyline(self, polyline: 'QPolygonF') -> None: ...
    # @typing.overload  # fixes issue #4
    ...
    @typing.overload
    def drawRects(self, rect: QtCore.QRectF, *a1: typing.Any) -> None: ...
    @typing.overload
    def drawRects(self, rects: typing.Iterable[QtCore.QRectF]) -> None: ...
    @typing.overload
    def drawRects(self, rect: QtCore.QRect, *a1: typing.Any) -> None: ...
    @typing.overload
    def drawRects(self, rects: typing.Iterable[QtCore.QRect]) -> None: ...
    @typing.overload
    def drawLines(self, line: QtCore.QLineF, *a1: typing.Any) -> None: ...
    @typing.overload
    def drawLines(self, lines: typing.Iterable[QtCore.QLineF]) -> None: ...
    @typing.overload
    def drawLines(self, pointPair: typing.Union[QtCore.QPointF, QtCore.QPoint], *a1: typing.Any) -> None: ...
    @typing.overload
    def drawLines(self, pointPairs: typing.Iterable[typing.Union[QtCore.QPointF, QtCore.QPoint]]) -> None: ...
    @typing.overload
    def drawLines(self, line: QtCore.QLine, *a1: typing.Any) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawPoints(self, point: typing.Union[QtCore.QPointF, QtCore.QPoint], *a1: typing.Any) -> None: ...
    @typing.overload
...
class QPolygon(sip.simplewrapper):
    ...
    @typing.overload
    def putPoints(self, index: int, firstx: int, firsty: int, *a3: typing.Any) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setPoints(self, firstx: int, firsty: int, *a2: typing.Any) -> None: ...
