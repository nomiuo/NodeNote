...
class QCamera(QMediaObject):
    ...
    @typing.overload
    def setViewfinder(self, viewfinder: QtMultimediaWidgets.QVideoWidget) -> None: ...
    @typing.overload
    def setViewfinder(self, viewfinder: QtMultimediaWidgets.QGraphicsVideoItem) -> None: ...
    @typing.overload
...
class QMediaPlayer(QMediaObject):
    ...
    @typing.overload
    def setVideoOutput(self, a0: QtMultimediaWidgets.QVideoWidget) -> None: ...
    @typing.overload
    def setVideoOutput(self, a0: QtMultimediaWidgets.QGraphicsVideoItem) -> None: ...
    @typing.overload
...
class QVideoWindowControl(QMediaControl):
    ...
    def setWinId(self, id: sip.voidptr) -> None: ...
